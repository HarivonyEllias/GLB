...
function Marque(){
  ...
  useEffect(() => {
    ...
    axios.get(url + "marque/total-count")
        .then(response => {
...
//////// DELETE
  ...
  const fetchData = () => {
    ...
    fetch(`${url}marque/page?pageSize=${page}&offset=${pageSize}`)
    // fetch(`${url}marque/page?pageSize=1&offset=10`)
  ...
  return (
    ...
    <header>
        <h1>Marque</h1>
        <button className="add-button" onClick={handleShow}>Add Marque</button>
    </header>
    <main>
        <table>
            <thead>
